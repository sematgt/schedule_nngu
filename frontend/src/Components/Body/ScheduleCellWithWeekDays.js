...
export default function ScheduleCellWithWeekDays(props) {
    ...
    return( 
            <div 
                className={["Schedule-cell", (props.day.date === date.toISOString().slice(0,10) && current_week_parity === props.selected_week_fulltime) ? "Schedule-cell-weekday-today" : "Schedule-cell-weekday"].join(' ')} 
                key={props.day.day}
            >
